  ...
  <div class="inline">
    <?php if($_SESSION['level']!="faculty") : ?>
      ...
      <span class="inline" style="vertical-align: middle;padding:10px 0 0 10px">Batch:</span>
        <select name="fac_id" id="faculty"  data-placeholder="Choose Batch...">
          <?php
          ...
          <div class="elements">
            <form method="post" action="courses.php?action=add">
              ...
              <input type="text" name="cName" class="styled details" required pattern=".{6,100}" title="6 to 100 characters" placeholder="Course Name" />
               <input type="text" name="cCredits" class="styled details" required pattern=".{0,2}" title="Maximum 9 Credits" placeholder="Credits" />
              <select name="batch[]" id="allowed" multiple="" class="stretch"  data-placeholder="Allowed Faculty..." required>
                <?php
