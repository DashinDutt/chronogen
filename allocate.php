      ...
      <form id="courseAlloc" action="allocate.php?action=saveSlots">
        ...
        <?php if(valueCheck("error","conflict")): ?>
          <div class="blocktext info error">
            <b>&#10006; </b>&nbsp; Another batch has just allocated one of the slots. Please try again
          </div>
        <?php else: ?>
...
<div id="footer">Powered by <a href="https://vashisthbhushan.com">Uttkarsh & Vashisth</a></div>
    ...
    <?php if(!sessionCheck('level','Batches')) : ?>
    ...
    <?php endif; ?>
      <div class="title" style="padding: 15px 0">Courses to Assign</div>
      <div id="courseScroll">
        <?php
        foreach ($courses as $course)
        {
