...
<head>
  ...
  $(function()
  {
      ...
      for(i=0;i<timetable.length;i++)
      {
        ...
        $gghh=timetable[i].course_name+"("+timetable[i].course_id+")";
        var course=$('<td>'+$gghh+'</td>');
...
"></div>
  ...
  <div id="content" style="padding:15px 0 0 15px;overflow-x: visible">
    <div>
      <form id="filters">
        ...
        <?php if(!valueCheck('print',true) || (isset($_GET['faculty']))): ?>
          ...
          <select id="faculty" name="faculty" data-placeholder="Choose Batch...">
        ...
        <?php if(!valueCheck('print',true) || (isset($_GET['batch']))): ?>
          ...
          <select id="batch" name="batch" data-placeholder="Choose Faculty...">
    ...
    <div class="tableContainer" >
      ...
      <div id="footer" style="position: relative">Powered by <a href="https://vashisthbhushan.com">Uttkarsh & Vashisth</a></div>
    </div>
